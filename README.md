...
| C   | [C](https://github.com/codewithfahmi/hello-world-in-several-programming-languages/tree/main/c)                       | .c       | <pre lang="c">#include <stdio.h><br>int main() {<br> printf("Hello, World!");<br> return 0;<br>}</pre>                      |
